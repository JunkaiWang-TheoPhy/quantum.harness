...
\item \textbf{Certified anticommuting norm compression at D4 and D5.}  We construct a
  ...
  translation-cell bound from 20.160968407335066 to 6.472926505087888 and
  replaces the generic D5 majorant by a 605,832-term exact grouped witness.
...
\item \textbf{An independently reproducible finite-instance result.}  For a
  $12\times12$ periodic Heisenberg lattice, the certificate accepts 95 steps
  and rejects 94.  Relative to a pinned 393-step instantiation of the
  published high-order theorem, this reduces merged group exponentials from
  11,791 to 2,851.  A fast verifier, a standard-library reference verifier,
  deep regeneration mode, a nondegenerate dense cross-check, mutation tests,
  and a SHA-256 manifest support the claim.
\end{enumerate}
...
The $r=78$ arithmetic identifies a possible fivefold threshold, but the
current D4 contribution already exceeds the complete error budget there.
Thus the arithmetic does not establish fivefold performance.  Throughout this manuscript,
