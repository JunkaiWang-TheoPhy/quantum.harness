...
\begin{figure}[t]
  ...
  95-step result remains the lowest accepted point of the current bound.}
  \label{fig:fivefold-gap}
\end{figure}

A disciplined optimization sequence is therefore: (1) profile the current
95-step error ledger; (2) improve the dominant D4 norm while preserving a
...
The rejection at 94 establishes adjacent minimality only under the emitted
...
what can be guaranteed, not an assertion that 95 executions are necessary.
