...
\large A Machine-Certified $4.135742\times$ Reduction for a\\
...
\input{sections/free_lie}
\input{sections/pauli}
\input{sections/norm_certificate}
\input{sections/finite_step}
