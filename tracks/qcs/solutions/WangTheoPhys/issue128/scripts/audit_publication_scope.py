...
_PAPER_A_RELEASE_PATHS = {
    ...
    "benchmarks/paper-a/ablation.json",
    "benchmarks/paper-a/ed-calibration.json",
    "benchmarks/paper-a/heldout-tfim.json",
    ...
    "scripts/build_paper_a_ablation.py",
    ...
    "tests/test_heldout_model.py",
    "tests/test_paper_a_ablation.py",
...
_REQUIRED_OWNERSHIP = {
    ...
    "benchmarks/paper-a/ablation.json": "paper-a",
    "benchmarks/paper-a/heldout-tfim.json": "paper-a",
    "certificates/issue128-certificate.json": "paper-a",
    "docs/experiments/processor-obstruction/tfim-family-obstruction.json": "paper-b",
    _D6_RUNTIME_EXCEPTION: "shared",
    _FIVEFOLD_LIMITATIONS_EXCEPTION: "paper-a",
    "scripts/build_paper_a_ablation.py": "paper-a",
    "scripts/certify_tfim_obstruction.py": "paper-b",
    "scripts/package_delivery.py": "obsolete",
    "scripts/run_heldout_model.py": "paper-a",
    "src/trottercert/tfim_obstruction.py": "paper-b",
    "tests/test_delivery_package.py": "obsolete",
    "tests/test_heldout_model.py": "paper-a",
    "tests/test_paper_a_ablation.py": "paper-a",
    "tests/test_tfim_obstruction.py": "paper-b",
}
